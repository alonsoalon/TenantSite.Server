    ...
    public class SettingService : ISettingService
    {
        ...
        private string ConfigDir {
            get {
                ...
                var filePath = baseDirectory.Substring(0, baseDirectory.IndexOf("AlonsoAdmin.HttpApi.Init")) + "AlonsoAdmin.HttpApi";
                return filePath;
            }
        }
        ...
        public Task<bool> WriteConfig<T>(string node, Action<T> applyChanges) 
        {
        ...
        public Task<bool> WriteTenantsConfig(List<TenantInfo> tenants)
        {
            string node = "Tenants";
            var filePath = Path.Combine(ConfigDir, "appsettings.json");
